...
class StatePublisher(Node):
    ...
    def __init__(self):
        ...
        #Just as a test it publishes it to the terminal
    def topic_callback(self, message):
        self.get_logger().info('I read angle value: "{0}"'.format(message.data))
        self.angle1 = message.data
        self.angle2 = message.data
